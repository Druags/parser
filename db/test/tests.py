...
from db.code.models import UserORM, Base, TitleORM, AuthorORM, ArtistORM, PublisherORM, TagORM, AbandonedTitleORM
from db.code.queries import fill_table, add_categories, add_id_to_id_conn, get_id, add_full_title
...
class TestQueries(unittest.TestCase):
    ...
    def test_positive_get_id(self):
        result = get_id(self.session_factory, AuthorORM, 'name')
        self.assertEqual(1, result)

    def test_negative_get_id(self):
        result = get_id(self.session_factory, AuthorORM, numpy.nan)
