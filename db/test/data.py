...
good_user_full_data = pd.DataFrame({'url': [1],
                                    ...
                                    'favorite_tags': [{'Романтика': '726', 'Драма': '548', 'Яой': '525', 'Фэнтези': '301', 'Комедия': '286', 'Повседневность': '226'}]})
...
good_title_full_data = pd.DataFrame({'type': ['Манхва', 'Манга'],
                                     ...
                                     'stats': [
                                         {'Читаю': 451, 'В планах': 1073, 'Брошено': 290, 'Прочитано': 358, 'Любимое': 28, 'Другое': 154},
                                         ""],
                                     'ratings': [{10: 21, 9: 15, 8: 1, 7: 21, 6: 9, 5: 21}, ""],
